...
export default function Get_ten_new_point() {
  return (
    <div className='w-[1239px] h-[218px]
     ...
     flex justify-between  items-center pr-[50px] pl-[50px]'>

        <div className='flex flex-col gap-[10px]'>
            <p className='font-normal text-[32px] leading-[52px] text-[#101B21]'>
            Get 10 free point 
            </p>
            <p className='w-[494px] text-wrap font-normal text-[18px] text-[#101B21]'>
